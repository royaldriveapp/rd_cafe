...
const localMenuItems: MenuItem[] = [
  // Coffee
  { id: "1", name: "Signature Latte", description: "Smooth espresso with silky steamed milk and artisan latte art", price: "$5.50", category: "coffee", image: latteImage, videoUrl: "https://www.youtube.com/watch?v=fN_iiDCxjPo" },
  { id: "2", name: "Classic Espresso", description: "Rich, bold, and perfectly extracted single origin beans", price: "$4.00", category: "coffee", image: espressoImage, videoUrl: "https://www.youtube.com/watch?v=fN_iiDCxjPo" },
