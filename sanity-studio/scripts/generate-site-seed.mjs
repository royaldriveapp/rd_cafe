...
const documents = [
  {
    ...
    businessHours: [
      { _type: "object", label: "Monday to Sunday", value: "7:00 AM – 2:00 AM" },
    ],
    addressLines: ["INTUC Bus Stop, 220/B, NH66, Nettoor, Maradu, Kochi", "Ernakulam, Kerala 682040, India"],
    ...
    visitCta: {
      ...
      buttonLink: "/contact",
      infoCards: [
        { _type: "object", iconKey: "mapPin", title: "Find Us", lines: ["INTUC Bus Stop, 220/B, NH66, Nettoor, Maradu, Kochi", "Ernakulam, Kerala 682040, India"] },
        { _type: "object", iconKey: "clock", title: "Hours", lines: ["Monday to Sunday: 7:00 AM – 2:00 AM"] },
      ],
    },
  },
  {
